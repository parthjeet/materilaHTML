...
<html lang="en">
  <head>
    ...
    <title>Contact Us 2 | Material</title>
  ...
  <body>
            ...
            <div class="collapse navbar-collapse" id="main-navbar">
              <ul class="navbar-nav mr-auto w-100 justify-content-end">
                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="contact-us.php">Contact Us 1</a>
                    <a class="dropdown-item active" href="contact-us2.php">Contact Us 2</a>
                  </div>
                </li>
              </ul>
              <!-- Search Box Start -->
          ...
          <ul class="wpb-mobile-menu">
            ...
            <li>
              ...
              <ul class="dropdown">
                ...
                <li>
                  <a class="active" href="contact-us2.php">Contact Us 2</a>
                </li>
              </ul>
            </li>
          </ul>
                  ...
                  <div class="col-md-12">
                      <div class="title-center">
                          <div class="title-middle">
                              ...
                              <h1 class="page-title text-center">Contact Us 2</h1>
                          </div>
                      </div>
                  </div>
              </div>
      ...
      <section class="Material-contact-section section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="contact-title text-center wow animated fadeInDown" data-wow-delay=".2s">We’re always here to hear form you</h1>
                </div>
            </div>
            <div class="row mt-5">
                <!-- Section Titile -->
                <div class="col-md-6 contact-widget-section2 wow fadeInUp animated" data-wow-delay=".5s">
                    ...
                    <div class="find-widget">
                      <a href="#"><i class="material-icons mdi mdi-home"></i> 4435 Berkshire Circle Knoxville</a>
                    </div>
                    <div class="find-widget">
                        <a href="#"><i class="material-icons mdi mdi-email"></i> hello@Material.com</a>
                    </div>
                    <div class="find-widget">
                        <a href="#"><i class="material-icons mdi mdi-phone mr-3"></i> 879-890-9767</a>
                    </div>
                    <div class="find-widget">
