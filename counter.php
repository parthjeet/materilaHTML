              ...
              <ul class="navbar-nav mr-auto w-100 justify-content-end">
                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item active" href="counter.php">Counter</a>
          ...
          <ul class="wpb-mobile-menu">
            ...
            <li>
              ...
              <ul class="dropdown">
                ...
                <li>
                    <a class="active" href="counter.php">Counter</a>
                </li>
                <li>
                ...
                <div class="col-md-12">
                    <div class="title-center">
                        <div class="title-middle">
                            <h2 class="page-tagline">Material Shortcode</h2>
                            <h1 class="page-title text-center">Counter</h1>
                        </div>
                    </div>
                </div>
            </div>
