...
<head>
    ...
    <title>FABRIC CUTTING MACHINES</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Cutting Machines</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <img src="/materilaHTML/assets/images/Facility/Cutting/0.jpg" class="img-fluid w-50">
                <div class="text-justify section-padding">
                    <p class="h4 text-center"><strong>FABRIC CUTTING MACHINES </strong></p>
                    <br>
                   <div class="table-responsive section-padding">
                        <table class="table table-hover section-padding">
                            ...
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">CUTTING MACHINES</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td><a href="CUcomp.php">Manual v/s Automatic Cutting Machines</a></td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                <td><a href="CUmanual.php">Manual Cutting Machines</a></td>
                            </tr>
                            <tr>
                                <th scope="row">3</th>
                                <td><a href="CUstraight.php">Straight Knife Cutting Machines</a></td>
                            </tr>
                            <tr>
                                <th scope="row">4</th>
                                <td><a href="CUround.php">Round Knife Cutting Machine</a></td>
                            </tr>
                            <tr>
                                <th scope="row">5</th>
                                <td><a href="CUband.php">Band Knife Cutting Machine</a></td>
                            </tr>
                            <tr>
                                <th scope="row">6</th>
                                <td><a href="CUend.php">End Cutters</a></td>
                            </tr>
                            <tr>
                                <th scope="row">7</th>
                                <td><a href="CUnotcher.php">Notchers</a></td>
                            </tr>
                            <tr>
                                <th scope="row">8</th>
                                <td><a href="CUauto.php">Automatic Cutting Machine</a></td>
                            </tr>
