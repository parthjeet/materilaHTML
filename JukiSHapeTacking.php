...
<head>
    ...
    <title>Shape Tacking Machine</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Shape Tacking Machine</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p class="text-justify h4"><strong>1. LK-1910 Series  </strong></p>
                <ul class="text-left">
                    <li>Computer-controlled, High-speed Shape-tacking Machine
                    </li>
                    <li>LK-1910, LK-1920(with intermediate presser), LK-1930(with intermediate presser and input function)
                    </li>
                    <li>The machine is fully equipped with state-of-the-art features such as a higher presser foot lift, a double-capacity shuttle hook, and a direct-control machine head that ensures quick response and an accurate stop position.
                    </li>
                    <li>Fewer bobbin thread changes
                    </li>
                    <li>Fully equipped easy-to-use operation panel [LK-1910, -1920] With its automatic correction feature, the machine can enlarge/reduce patterns without deformation.
                    </li>
                    <li>Intermediate presser that securely clamps the material
                    </li>
                </ul>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/ShapeTacking/0.jpg" class="img-fluid w-50"> <br><br>
                </div>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/ShapeTacking/2.JPG" class="img-fluid w-50"> <br><br>
                </div>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/ShapeTacking/1.JPG" class="img-fluid w-100"> <br><br>
                </div>
                <br>
                <div class="text-center">
                    <p class="h5 text-center">
                        <a href="http://www.juki.co.jp/industrial_e/download_e/catalog_e/lk1910.pdf"
