...
<head>
    ...
    <title>Double Needle Lock Stitch (DNLS) Machine</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Double Needle Lock Stitch (DNLS) Machine</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p class="text-justify h4"><strong>LH-3500A Series  </strong></p>
                <ul class="text-left">
                    <li>
                        <ul>
                            <li>Adoption of the <strong>direct-drive</strong> mechanism promises energy-saving and increased workability.</li>
                            <li>This is the cutting-edge model 2-needle sewing machine which comes with substantially enhanced mechanisms such as the direct-drive mechanism, semi-dry head, new thread tension control mechanism and improved oiling system.</li>
                            <li>The "large-hook type" uses a hook 1.7 times larger than standard. This increase in size reduces the frequency of bobbin-thread changes</li>
                        </ul>
                    </li>
                </ul>
                <div class="text-center section-padding">
                    <img src="/materilaHTML/assets/images/Facility/Juki/DNLS/0.jpg" class="img-fluid w-25"> <br><br>
                </div>
                <div class="text-center section-padding">
                    <img src="/materilaHTML/assets/images/Facility/Juki/DNLS/1.JPG" class="img-fluid w-100"> <br><br>
                </div>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/DNLS/2.JPG" class="img-fluid w-100"> <br><br>
                </div>
                <br>
                <div class="text-center">
                    <p class="h5 text-center">
                        <a href="http://www.juki.co.jp/industrial_e/download_e/catalog_e/lh3500a.pdf"
