...
<div class="container  ">
    <table class="table table-hover section-padding">
        ...
        <tr>
        <th scope="row">1</th>
        <td><a href="index.php">Tobacco Smoke Control</a></td>
        </tr>
        <tr>
            <th scope="row">2</th>
            <td><a href="index.php">Minimum Fresh Air Requirements</a></td>
        </tr>
        <tr>
            <th scope="row">3</th>
            <td><a href="index.php">Improved Fresh Air Ventilation</a></td>
        </tr>
        <tr>
            <th scope="row">4</th>
            <td><a href="index.php">Avoid use of Asbestos in the Building</a></td>
        </tr>
        <tr>
            <th scope="row">5</th>
            <td><a href="index.php">Building Flush Out</a></td>
        </tr>
        <tr>
            <th scope="row">6</th>
            <td><a href="index.php">Day lighting</a></td>
        </tr>
        <tr>
            <th scope="row">7</th>
            <td><a href="index.php">Low VOC Materials</a></td>
        </tr>
        <tr>
            <th scope="row">8</th>
            <td><a href="index.php">Reduction of Workmen Fatigue (Break out spaces)</a></td>
        </tr>
        <tr>
            <th scope="row">9</th>
            <td><a href="index.php">DEco-Friendly House-Keeping Chemicals</a></td>
        </tr>
        <tr>
            <th scope="row">10</th>
            <td><a href="index.php">Aerobic & Cardiovascular Gymnasium</a></td>
        </tr>
        <tr>
            <th scope="row">11</th>
        ...
        <tr>
            <th scope="row">12</th>
            <td><a href="index.php">Ensure Quality Water</a></td>
        </tr>
