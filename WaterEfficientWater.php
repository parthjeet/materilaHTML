...
<head>
    ...
    <title>Efficient water use during Construction</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Efficient water use during Construction</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="text-justify section-padding">
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>To minimize use of potable water during construction.</p>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center align-middle">
                            ...
                            <td>
                                <p>&middot; Use materials such as pre-mixed concrete for preventing water loss during mixing.</p>
                                <p>&middot; Use recycled treated water.</p>
                                <p>&middot; Control the waste of curing water</p>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center align-middle">
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <img src="/materilaHTML/assets/images/ArchitecturalDesign/Water/ProcessFlow/1.png" alt="" class="img-responsive">
                    ...
                    <p><strong>Activities where majority of water wastage occurs:</strong></p>
                    <ol>
                        <li>General dust suppression, suppression on site roads and wheel washes</li>
                        <li>Hydro-demolition with high pressure water</li>
                        <li>Lorry wash out</li>
                        <li>Wash out of ready mixed concrete wagons</li>
                    ...
                    <div class="text-center section-padding">
                        <img src="/materilaHTML/assets/images/ArchitecturalDesign/Water/1/2.png" alt="" class="img-fluid w-75">
                    </div>
