...
<head>
    ...
    <title>Cuff Preparation Machines</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Cuff Preparation Machines</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="text-justify section-padding">
                    <div class="text-center">
                        <img src="/materilaHTML/assets/images/Facility/Shirt/1.6.JPG" class="img-fluid w-50"> <br><br>
                    </div>
                    <p class="h4"><strong> Brand: HASHIMA- 1 KH-220</strong></p>
                    <ul>
                        <li><strong> Features:</strong>
                            <ol>
                                ...
                                <li>Expandable mould to form the shape of cuff and clip to fix the cuff position for
                                    fine pressing effect
                                </li>
                                <li>Automatically collecting materials with air blowing after cuff pressing with high
                                    productivity efficiency
                                </li>
                                <li>Average production is 2400 pcs/8 hrs</li>
                            </ol>
                        </li>
                    ...
                    <br>
                    <div class="text-center">
                        <img src="/materilaHTML/assets/images/Facility/Shirt/6.JPG" class="img-fluid w-50"> <br><br>
                    </div>

                    <div>
                        <p class="img-padding-left-right ">&nbsp;Source: (<a
                                    href="https://www.iigm.in/Industries/Apparel/MID-Process/Shirt-Cuff-Preparation-Machines/Br">Shirt-Cuff-Preparation-Machines:IIGM</a>)
                        </p>
                    </div>
