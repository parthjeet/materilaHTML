...
<head>
    ...
    <title>Department Wise Area Calculation</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Department Wise Area Calculation</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="text-justify ">
                    ...
                    <div class="table-responsive section-padding">
                        ...
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">DEPARTMENT WISE AREA CALCULATION</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td><a href="PlantCalculation.php">Main Entrance, Security Cabin and Admin</a></td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td><a href="Canteen.php">Canteen, Locker Room and Crèche</a></td>
                        </tr>
                        <tr>
                            <th scope="row">3</th>
                            <td><a href="Medical.php">Medical Room and Parking</a></td>
                        </tr>
                        <tr>
                            <th scope="row">4</th>
                            <td><a href="Training.php">Training Center and Sampling Department</a></td>
                        </tr>
                        <tr>
                            <th scope="row">5</th>
                            <td><a href="FabricTrim.php">Fabric and Trim Store</a></td>
                        </tr>
                        <tr>
                            <th scope="row">6</th>
                            <td><a href="SpreadingCutting.php">Spreading and Cutting Department</a></td>
                        </tr>
                        <tr>
                            <th scope="row">7</th>
                        ...
                        <tr>
                            <th scope="row">8</th>
                            <td><a href="QAfinishing.php">QA and Finishing Department</a></td>
                        </tr>
                        <tr>
                            <th scope="row">9</th>
                            <td><a href="CAD.php">CAD Department and Warehouse</a></td>
                        </tr>
                        <tr>
                            <th scope="row">10</th>
                            <td><a href="SewingCal.php">Sewing Department</a></td>
                        </tr>
