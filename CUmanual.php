...
<head>
    ...
    <title>Manual Cutting Machine</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Manual Cutting Machine</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="text-left section-padding">
                    <p class="text-center h5 "><strong>	Type of Manual Cutting Machines and their uses:</strong> </p>
                </div>
                ...
                <table class="table table-bordered table-striped-green w-100 text-center align-middle">
                    ...
                    <tr>
                        <td>
                            <p><strong>Straight Knives</strong></p>
                        </td>
                        <td>
                            <p>High-speed reciprocating cutting technology designed for cutting patterns, as well as straight lines in multiple thicknesses of material</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p><strong>Round Knives</strong></p>
                        </td>
                        <td>
                            <p>Commonly used to cut straight lines or large radius curves</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p><strong>Band knives</strong></p>
                        </td>
                        <td>
                            <p>Commonly used to cut curved patterns and small parts</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p><strong>Rotary Shears</strong></p>
                        </td>
                        <td>
                            <p>Quickly cut intricate markers, one-of-a-kind patterns, and samples. Solution to low-quantity cutting jobs.</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p><strong>End Cutters</strong></p>
                        </td>
                        <td>
                            <p>Fast, efficient, accurate straight end cuts to minimize excessive selvage</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p><strong>Drills/Marking/Special Applications</strong></p>
                        </td>
                        <td>
                            <p>Make buttonholes, darts, or other markings; pattern perforating, bundling, strip cutting, and rag manufacturing</p>
                        </td>
                    </tr>
                    </tbody>
                </table></>
                <p>(Source- <a href="https://www.eastmancuts.com/product-category/products/manual-products/">EASTMAN</a>)</p>
            </div>
        </div>
    </div>
</section>
