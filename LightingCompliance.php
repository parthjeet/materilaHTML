...
<head>
    ...
    <title>Existing Compliances and Practices</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Existing Compliances and Practices</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="text-left section-padding">
                    <p>Compliance assurance by RMG sectors is becoming vitally important in apparel business, as consumers of developed countries are becoming increasingly concerned about work and social environment in the sourcing factories. Compliance standards of RMG units varied widely in respect of size of operation and type of compliance. A common compliance standard needs to be established that would take care of domestic legislation as well as buyers' requirement (code of conduct) which would be enforced through the monitoring agency. In European countries, the codes go as far to prescribe a minimum window size and daylight factor as well as ensuring that the windows are positioned in such a way to provide a view for all for the occupants, and to reduce the brightness to the interior (which can cause glare) (Ruck, et al. 2000).</p>
                    <p>Requirements and measurement parameters can be found in:</p>
                    <ul class="h6">
                        <li>The ILO Core Labor Conventions (C155, C161)<br> <br></li>
                        <li>Standards as given by the Occupational Safety and Health Authority (OSHA) of the US Labor Department
                            <br> <br></li>
                        <li>International standards (SA8000, BSCI, ETI, WRAP, etc.) and buyers&rsquo; codes of conduct.br </li>
                    </ul>
                </div>
