...
<html lang="en">
  <head>
    ...
    <title>Portfolio Details | Material</title>
              ...
              <ul class="navbar-nav mr-auto w-100 justify-content-end">
                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item active" href="portfolio-single.php">Portfolio Single</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <ul class="wpb-mobile-menu">
            ...
            <li>
              ...
              <ul class="dropdown">
                ...
                <li>
                  <a class="active" href="portfolio-single.php">Portfolio Single</a>
                </li>
              </ul>
            </li>
            <li>
                  ...
                  <div class="col-md-12">
                      <div class="title-center">
                          <div class="title-middle">
                              <h2 class="page-tagline">Works in details</h2>
                              <h1 class="page-title text-center">Portfolio Details</h1>
                          </div>
                      </div>
                  </div>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 portfolio-details-iamge wow animated fadeInUp" data-wow-delay=".6s">
              <img src="assets/images/portfolio/portfolio-details.png" class="img-fluid" alt="">
                <h2>Project Info:</h2>
            ...
            <div class="col-md-4 portfolio-details wow animated fadeInUp" data-wow-delay=".6s">
              <div class="portfolio-category">
                <a href="#"><i class="material-icons mdi mdi-bookmark-outline"></i> Wordpress Theme</a>
              </div>
              <h2>CONBIZ</h2>
              ...
              <a href="javascript:void(0)" class="mt-3 btn btn-common btn-block"><i class="material-icons mdi mdi-eye"></i> Live Demo<div class="ripple-container"></div></a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col-md-4 col-lg-4 col-xl-6  Material-title-section wow animated fadeInLeft" data-wow-delay=".2s">
                <h1 class="small-title">Related Work</h1>
              </div>
