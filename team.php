  ...
  <body>
                  ...
                  <div class="col-md-12">
                      <div class="title-center">
                          <div class="title-middle">
                              ...
                              <h1 class="page-title text-center">Team</h1>
                          </div>
                      </div>
                  </div>
              </div>
      ...
      <section class="team section-padding section-dark"> 
        <div class="container">
            <div class="row">
                <!-- Single Team Widget -->
                <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInUp animated" data-wow-delay=".1s">
                    <div class="single-team-widget">
                        <img src="assets/images/team/team1.jpg" class="img-fluid" alt="">
                        <div class="team-member-info">
                            <div class="know-more">
                                <a class="btn btn-round btn-fab btn-xs" href="team-single.php"><i class="material-icons mdi mdi-arrow-right"></i><div class="ripple-container"></div></a>
                            </div>
                ...
                <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInUp animated" data-wow-delay=".5s">
                 ...
                 <!-- Single Team Widget -->
                <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInUp animated" data-wow-delay=".6s">
                    <div class="single-team-widget">
                        <img src="assets/images/team/team2.jpg" class="img-fluid" alt="">
                        <div class="team-member-info">
                            <div class="know-more">
                 ...
                 <!-- Single Team Widget -->
                <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInUp animated" data-wow-delay=".7s">
                    <div class="single-team-widget">
                        <img src="assets/images/team/team3.jpg" class="img-fluid" alt="">
                        <div class="team-member-info">
                            <div class="know-more">
                ...
                <!-- Single Team Widget -->
                <div class="col-md-6 col-lg-3 col-xl-3 wow fadeInUp animated" data-wow-delay=".8s">
                    <div class="single-team-widget">
                        <img src="assets/images/team/team4.jpg" class="img-fluid" alt="">
                        <div class="team-member-info">
                            <div class="know-more">
