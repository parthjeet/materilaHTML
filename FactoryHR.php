...
<head>
    ...
    <title>Factory HR, PPC and IE Department Area Calculation</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Factory HR, PPC and IE Department Area Calculation</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="text-justify     section-padding">
                    ...
                    <table class="table table-bordered table-striped-green text-center  w-75">
                        ...
                        <tr>
                            ...
                            <td>
                                <p><strong>132 sq.ft</strong></p>
                            </td>
                        </tr>
                        </tbody>
                    </table></div>
                    <div class="well w-75 text-center align-middle">
                        <p class="img-padding-left-right">Total factory HR Area = 2.5 * 132 sqft = 330 sqft</p>
                    </div>

                    <hr class="section-padding">

                   <h3>2. 	PPC DEPARTMENT</h3>
                    <br>
                    <div class="table-responsive">
                    <table class="table table-bordered table-striped-green text-center w-75">
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p><strong>242 sqft</strong></p>
                            </td>
                        </tr>
                        </tbody>
                    </table></div>
                    <div class="well w-75 text-center align-middle">
                        <p class="img-padding-left-right">Total area occupied = 2.5 * Area Occupied = 2.5 * 242 = 605 sqft</p>
                    </div>
                    <hr class="section-padding">

                    <h3>3. IE DEPARTMENT</h3>
                    <div class="table-responsive">
                    <table class="table table-bordered table-striped-green text-center w-75">
                        <tbody >
                        <tr>
                    ...
                    <br>
                    <div class="well w-75">
                        <p class="img-padding-left-right">Total area occupied = 2.5 * Area Occupied = 2.5 * 281= 702 sq. ft.</p>
                    </div>
