...
<head>
    ...
    <title>Bar Tacking Machine</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Bar Tacking Machine</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="text-justify section-padding">
                    ...
                    <p class="h4"><strong>MODEL NO:  KE-430HX Electronic Direct Drive Lockstitch Bar Tacker </strong></p>
                    <p>Stable thread tightening and thread trimmer when sewing from foundation to denim. High quality sewing will be realized at various materials. KE-430F gains high productivity as it's the worlds’ fastest cycle time.</p>

                    <p><strong>Features:</strong></p>
                    <ol>
                        <li>Beautiful sewing and easy to adjust sewing functions</li>
                        <li>Stable sewing quality with Digital Tension</li>
                        <li>Extremely low noise and vibration for operator-friendly sewing</li>
                        <li>Overwhelmingly superior productivity with the world's fastest cycle time</li>
                        <li>High energy saving</li>
                        <li>Easy maintenance</li>
                        <li>Clean sewing with semi-dry type</li>
                        <li>User-friendly operations panel</li>
                    ...
                    <div>
                        <p class="img-padding-left-right">&nbsp;<a
                                    href="http://www.brother-usa.com/VirData/Content/en-US/IPD/ModelBrochures/430HXHS-438HX-US_1_piece.pdf">Download Manual Here</a></p>
                    </div>
