            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Post Bed Machine</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p class="text-justify h4"><strong>1. DP-2100 </strong></p>
                <ul class="text-left">
                    <li> <strong>Computer-controlled, </strong> Dry-head, Lockstitch Sleeve Setting Machine with Multi-programming Device.
                    </li>
                    <li> Highly-reliable <strong>direct-drive</strong> system.
                    </li>

                </ul>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/PostBed/0.jpg" class="img-fluid w-25"> <br><br>
                </div>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/PostBed/1.JPG" class="img-fluid w-50"> <br><br>
                </div>
                <br>
                <div class="text-center">
                    <p class="h5 text-center">
                        <a href="http://www.juki.co.jp/industrial_e/download_e/catalog_e/dp2100.pdf"
