            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Suggestions</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="text-left section-padding">
                    <ul>
                        <li>The illumination level at the work-plane of the workers should be within <strong>500-800 lux (average 700 lux)</strong> especially for <strong>Sewing Operators, Sewing Helpers and Quality Controllers. </strong>
                            </li>
                        <li>Architects should always accommodate <strong>daylight provisions</strong> along with designing glare controlling devises (e.g. Light shelves, adjustable shading device and others) to add more diffused daylight in indoors.
                            </li>
                        <li>Architects should maintain the minimum <strong>&ldquo;Window to Floor area ratio </strong>‟, with taking extra care on the glare so that more glare free natural lighting can be achieved inside the production spaces.
                            </li>
                        <li><strong>Local codes, standards and compliances should be developed</strong> or changed with promoting more daylight inclusion and supplement lighting layout with an energy evaluation study for designing efficient production space including workers health and safety.</li>
                        <li><strong>For sewing operations, additional task lighting is to be provided in the machine in such a way that the visibility of the needle points will be optimum. </strong></li>
                        <li><strong>Replace normal fluorescent lamp to LED tube lights</strong>, LEDs are more expensive initially but they consume less power and are more durable.</li>
                    </ul>
                </div>
                </div>
        </div>
