...
<head>
    ...
    <title>Button Sewing Machine</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Button Sewing Machine</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p class="text-justify h4"><strong>1. LK-1903BN Series  </strong></p>
                <ul class="text-left">
                    <li>Computer-controlled, High-speed, Lockstitch, Button Sewing System </li> </ul>

                    <ul class="text-left">
                        <li><strong> LK-1903BNB </strong><br>
                        This model is provided with two functions; i.e., "bird's nest preventing function" and "shorter-thread remaining function". Preventing the sewing product from being damaged by manual thread-nipping with scissors. </li>
                      <li> <strong>	LK-1903BN </strong><br>
                          The machine achieves sewing speed of 2,700sti/min The machine's thread-trimming etc. have been increased to significantly shorten total cycle time. The machine is provided as standard with 50 different sewing patterns at higher productivity. </li>
                    <li> <strong> LK-1903BN/BR35 </strong> <br>
                        With their original horizontal forced feed mechanism, the button carrier sets a button in position so that the operation is simplified. Furthermore, operator fatigue is reduced since what operator needs to do is only setting material and pressing a pedal.
                    </li>
                </ul>

                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/ButtonSewing/0.jpg" class="img-fluid w-25"> <br><br>
                </div>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/ButtonSewing/1.JPG" class="img-fluid w-100"> <br><br>
                </div>
                <br>
                <div class="text-center">
                    <p class="h5 text-center">
                        <a href="http://www.juki.co.jp/industrial_e/download_e/catalog_e/lk1903bn.pdf"
