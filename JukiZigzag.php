            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Zig Zag Machine</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p class="text-justify h4"><strong>1. LZ-2280A Series  </strong></p>
                <ul class="text-left">
                    <li><strong>Computer-controlled, Direct-drive,</strong>  High-speed, 1-needle, Lockstitch, Zigzag Stitching Machine with Automatic Thread Trimmer (quick reverse type)
                    </li>
                    <li>This sewing machine <strong> reduces power consumption by 8.6% </strong>as compared with the conventional models
                    </li>
                </ul>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/Zigzag/0_1.jpg" class="img-fluid w-25"> <br><br>
                </div>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/Zigzag/1.JPG" class="img-fluid w-100"> <br><br>
                </div>
                <br>
                <div class="text-center">
                    <p class="h5 text-center">
                        <a href="http://www.juki.co.jp/industrial_e/download_e/catalog_e/lz2280a.pdf"
                           class="text-center">Download Manual Here</a>
                    </p></div>
                <hr class="section-padding">
                <p class="text-justify h4"><strong>2. LZ-2290A Series </strong></p>
                <ul class="text-left">
                    <li><strong> Computer-controlled, Direct-drive, </strong>High-speed, 1-needle, Lockstitch, Zigzag Stitching Machine, dramatically reduces the noise and vibration of the machine and helps reduce operator fatigue.s</li>
                </ul>

                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/Zigzag/0_2.jpg" class="img-fluid w-25">
                </div>
                <div class="text-center section-padding">
                    <img src="/materilaHTML/assets/images/Facility/Juki/Zigzag/2.JPG" class="img-fluid w-50">
                </div>
                <div class="text-center">
                    <p class="h5 text-center">
                        <a href="http://www.juki.co.jp/industrial_e/download_e/catalog_e/lz2290a.pdf"
                           class="text-center">Download Manual Here</a>
                    </p></div>
                <hr class="section-padding">

                <p class="text-justify h4"><strong>3. LZ-2290A Series</strong></p>
                <ul class="text-left">
                    <li> High-speed, Cylinder-bed, 1-needle, Lockstitch, Zigzag Stitching Machine with Automatic Thread Trimmer (with standard/3-step zigzag stitching pattern changeover function)</li>
                </ul>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Facility/Juki/Zigzag/0_3.jpg" class="img-fluid w-25">
                </div>
                <div class="text-center section-padding">
                    <img src="/materilaHTML/assets/images/Facility/Juki/Zigzag/3.JPG" class="img-fluid w-50">
                </div>
                <div class="text-center">
                    <p class="h5 text-center">
                        <a href="http://www.juki.co.jp/industrial_e/download_e/catalog_e/lz2280n.pdf"
                           class="text-center">Download Manual Here</a>
                    </p></div>
                </div>
                <hr class="section-padding">
