...
<head>
    ...
    <title>Men's Formal Shirt's Parts Preparation Machines</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Men's Formal Shirt's Parts Preparation Machines</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="text-justify section-padding">
                    ...
                    <div class="table-responsive section-padding">
                        ...
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">Men's Formal Shirt's Parts Preparation</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td><a href="Collar.php">Collar Preparation</a></td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td><a href="Cuff.php">Cuff Preparation</a></td>
                        </tr>
                        <tr>
                            <th scope="row">3</th>
                            <td><a href="Pocket.php">Pocket Preparation</a></td>
                        </tr>
                        <tr>
                            <th scope="row">4</th>
                            <td><a href="Fplacket.php">Front Placket Preparation</a></td>
                        </tr>
                        <tr>
                            <th scope="row">5</th>
                            <td><a href="SPlacket.php">Sleeve Placket Preparation</a></td>
                        </tr>
