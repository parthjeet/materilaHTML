...
<head>
    ...
    <title>Pocket Preparation Machines</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Pocket Preparation Machines</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="text-justify section-padding">
                    ...
                    <p class="h4"><strong> Pocket folding & Pressing NS-9084 S-ND</strong></p>
                    <p class="h6 img-padding-left-right"><strong>Pocket folding and pressing for thin fabric pockets of
                            any shape with a double press system
                        </strong></p>
                    <br>
                    <ul>
                        <li><strong> Features:</strong>
                            <ol>
                                <li>Fit for folding and pressing thin fabric pockets such as shirt, fabric etc.</li>
                                <li>Double press system: upper mould can retract and then press the pocket again ,
                                    result will be better
                                </li>
                                <li>Equipped with double posts to fix, make the upper mould more stable while running
                                </li>
                                <li>Could shift to round pocket , square pocket, hexangular , and triangular shaped
                                    pockets , high degree of automation
                                </li>
                                <li>Apply PLC and human friendly touch screen for operation</li>
                                <li>The lower mould can spray steam for more excellent pocket pressing</li>

                            </ol>
                            <br>
                    </ul>
                    <div class="text-center">
                        <img src="/materilaHTML/assets/images/Facility/Shirt/7.JPG" class="img-fluid w-50"> <br><br>
                    </div>

                    <div>
                        <p class="img-padding-left-right ">Source: (<a
                                    href="https://www.iigm.in/Industries/Apparel/MID-Process/Pocket-Preparation-Machines/Br">Pocket
                                Preparation machines: IIGM</a>)</p>
                    </div>
