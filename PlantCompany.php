            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Company Profile</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="text-left section-padding">
                    ...
                    <table class="table table-bordered table-striped-green align-middle text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <p><strong>ECO-FAB APPARELS LTD.</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <p>Chokkahalli Industrial Area, Bangalore.</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p><strong>TY</strong><strong>PE</strong></p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>Men&rsquo;s Formal Shirt &amp; Trouser</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p><strong>W</strong><strong>O</strong><strong>R</strong><strong>KFORCE</strong></p>
                            </td>
                            <td>
                                <p>2600</p>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>4000 shirts, 4000 Trouser</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p><strong>W</strong><strong>ORKING HRS</strong></p>
                            </td>
                            <td>
                                <p>9 AM TO 5:30 PM</p>
                            </td>
