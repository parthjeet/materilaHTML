...
<html lang="en">
  <head>
    ...
    <title>Portfolio 2 Column | Material</title>
        ...
        <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar nav-bg">
            ...
            <div class="collapse navbar-collapse" id="main-navbar">
              <ul class="navbar-nav mr-auto w-100 justify-content-end">
                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item active" href="portfolio-2.php">Portfolio 2 columns</a>
          ...
          <ul class="wpb-mobile-menu">
            ...
            <li>
              ...
              <ul class="dropdown">
                <li>
                  <a class="active" href="portfolio-2.php">Portfolio 2 columns</a>
                </li>
                <li>
                  ...
                  <div class="col-md-12">
                      <div class="title-center">
                          <div class="title-middle">
                              <h2 class="page-tagline">2 coulmn</h2>
      ...
      <div class="container">
          <div class="row">
            ...
            <div class="portfolio-item-wrapper clearfix wow animated fadeInUp" data-wow-delay=".5s" id="Material-portfolio">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 pb-4 mix business">
              ...
              <!-- Single Portfolio Image -->
              <div class="col-md-6 col-sm-6 col-xs-12 mix development more">
                  <figure class="single-portfolio">
              ...
              <!-- Single Portfolio Image -->
              <div class="col-md-6 col-sm-6 col-xs-12 mix creative business">
                  <figure class="single-portfolio">
              ...
              <!-- Single Portfolio Image -->
              <div class="col-md-6 col-sm-6 col-xs-12 mix creative more development">
                  <figure class="single-portfolio">
              ...
              <!-- Single Portfolio Image -->
              <div class="col-md-6 col-sm-6 col-xs-12 mix more development" >
                  <figure class="single-portfolio">
