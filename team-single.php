...
<html lang="en">
  ...
  <body>
              ...
              <ul class="navbar-nav mr-auto w-100 justify-content-end">
                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item active" href="team.php">Team Members</a>
          ...
          <ul class="wpb-mobile-menu">
            ...
            <li>
              ...
              <ul class="dropdown">
                ...
                <li>
                  <a class="active" href="team.php">Team Members</a>
                </li>
                <li>
                  ...
                  <div class="col-md-12">
                      <div class="title-center">
                          <div class="title-middle">
                              <h2 class="page-tagline">Meet our</h2>
                              <h1 class="page-title text-center">Team Single</h1>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
              <div class="team-thumb">
                <img class="img-fluid" src="assets/images/team/team1.jpg" alt="">
              </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
              <div class="team-text">
                <h3>Rob Percy</h3>
                <h5>Co-Founder</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid tenetur, praesentium perferendis dolorum unde eligendi atque nulla modi. Esse totam deleniti dolor ut consectetur porro, ex nostrum iste maxime fugit.</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid tenetur, praesentium perferendis dolorum unde eligendi atque nulla modi. Esse totam deleniti dolor ut consectetur porro, ex nostrum iste maxime fugit.</p>
      ...
      <section class="team-about section-padding section-dark"> 
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="single-about">
                <h3>About Me</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias autem a cum! Magni, enim sed facilis. Ratione repellendus deserunt officiis ...</p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="single-about">
