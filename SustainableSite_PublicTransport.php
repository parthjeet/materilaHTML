...
<head>
    ...
    <title>Access to Public Transport</title>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <p>Reduce air pollution and land development impacts from personal automobile use.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-center align-middle">
                        ...
                        <td class="text-justify">
                            <p>&middot; Locate the factory within 1.0 km walking distance from an intra-city railway station or a bus stop within 0.5 km walking distance.</p>
                            <p>&middot; Alternately, the factory can operate or have a contract in place for shuttle services to cover 40% of the employees.</p>
                            <p>&middot; Provide housing to cater to 40% of employees within a walking distance of 2 km from the</p>
                            <p>factory.</p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-justify">
                            <p>&middot; Provide a site plan indicating the project site and highlighting the intra city railway</p>
                            <p>&middot; station, sea port / airport and distance between them.</p>
                            <p>&middot; Provide the percentage of regularly employed personnel utilizing the shuttle facility</p>
                            <p>&middot; provided by the green factory.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-center align-middle">
                        ...
                        <td>
                            <img src="/materilaHTML/assets/images/ArchitecturalDesign/SiteSelection/Process%20Flow/4.png" alt="" class="img-responsive">
