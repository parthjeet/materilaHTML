...
<head>
    ...
    <title>Comparative Analysis of Different Manufacturing Systems</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Comparative Analysis of Different Manufacturing Systems</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="text-left section-padding">
                    <p class="h5">Read about below mentioned Garment Manufacturing Systems at <a href="http://www.indiantextilejournal.com/articles/FAdetails.asp?id=28">INDIAN TEXTILE JOURNAL</a></p>
                </div>
                <div class="text-center">
                    <img src="/materilaHTML/assets/images/Layouts/AvailablePS/ComparativeAnalysis/1.PNG" class="img-fluid w-100"> <br><br>
                </div>
                <p class="h4 jumbotron">Above analysis suggests that MODULAR Manufacturing system is the best system followed by the UPS and STRAIGHT LINE system.  </p>
