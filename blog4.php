...
<head>
    ...
    <title>Comparative Analysis of GRIHA certified Non-Garment related Buildings</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center">Comparative Analysis of GRIHA certified Non-Garment related Buildings</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <article class="single-post wow fadeInUp animated"  data-wow-delay=".2s">
                    ...
                    <div class="single-post-meta">
                        ...
                        <div class="share-post">
                            <a href="blog4Body.php"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-google-plus"></i></a> <a href="#"><i class="fa fa-pinterest"></i></a>
                        </div>
                    </div>
                </article>
