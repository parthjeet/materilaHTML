...
<head>
    ...
    <title>Manual v/s Automatic Cutting Machine</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Manual v/s Automatic Cutting Machine</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p class="h5">Benefits of Transitioning from Manual to Automated Cutting:</p>
                <br>
                <img src="/materilaHTML/assets/images/Facility/Cutting/6.jpg" class="img-fluid w-75">
                <div class="text-left section-padding">

                </div>

                <p>(Source- <a href="http://www.gerbertechnology.com/news/six-benefits-of-transitioning-from-manual-to-automated-cutting/">Six Benefits of Transitioning from Manual to Automated Cutting: GERBER</a>)</p>
            </div>
        </div>
    </div>
</section>
