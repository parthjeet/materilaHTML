...
<head>
    ...
    <title>Washing Department related Machines</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Washing Department related Machines</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <img src="/materilaHTML/assets/images/Facility/Washing/0.jpg" class="img-fluid w-75">
                <div class="text-justify ">
                    ...
                    <div class="table-responsive section-padding">
                        ...
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">Washing Department related Machines</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <th scope="row">1</th>
                            <td><a href="WashWash.php">Washing Machine</a></td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td><a href="WashDry.php">Dry Cleaning Machine</a></td>
                        </tr>
                        <tr>
                            <th scope="row">3</th>
                            <td><a href="WashTumble.php">Tumble Dry Machine</a></td>
                        </tr>
                        <tr>
                            <th scope="row">4</th>
                            <td><a href="WashHydro.php">Hydro Extractor</a></td>
                        </tr>
