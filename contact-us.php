...
<html lang="en">
  <head>
    ...
    <title>Contact Us | Material</title>
  ...
  <body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar nav-bg">
            ...
            <div class="collapse navbar-collapse" id="main-navbar">
              <ul class="navbar-nav mr-auto w-100 justify-content-end">
                ...
                <li class="nav-item dropdown active">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item active" href="contact-us.php">Contact Us 1</a>
                    <a class="dropdown-item" href="contact-us2.php">Contact Us 2</a>
                  </div>
                </li>
              </ul>
          ...
          <ul class="wpb-mobile-menu">
            ...
            <li>
              ...
              <ul class="dropdown">
                <li>
                  <a class="active" href="contact-us.php">Contact Us 1</a>
                </li>
                <li>
                  <a href="contact-us2.php">Contact Us 2</a>
                </li>
      ...
      <section class="Material-contact-section section-padding">
          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-12">
                      <h1 class="contact-title wow animated fadeInRight"  data-wow-delay=".3s">We’re always here to hear form you</h1>
                  </div>
              </div>
