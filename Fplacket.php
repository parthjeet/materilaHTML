...
<head>
    ...
    <title>Front Placket Preparation Machines</title>
            ...
            <div class="col-md-12">
                <div class="title-center">
                    <div class="title-middle">
                        <h1 class="page-title text-center text-center">Front Placket Preparation Machines</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="text-justify section-padding">
                    <div class="text-center">
                        <img src="/materilaHTML/assets/images/Facility/Shirt/1.8.JPG" class="img-fluid w-50"> <br><br>
                    </div>
                    <p class="h4"><strong> Front Placket Folding NS-5502</strong></p>
                    <p class="text-left h6"><strong>Specially designed for folding and pressing checks & striped
                            plackets with laser light for check and stripe matching</strong></p>
                    <ul>
                        <li><strong> Features:</strong>
                            <ol>
                                <li>PLC and human-machine touch screen control</li>
                                <li>Laser light assists check matching</li>
                                <li>Automatic fabric piece collecting and stacking, tidy and clean, with less crinkles
                                    and excellent folding effect
                                </li>
                                <li>Built-in silencer for less noise</li>
                                <li>With high sensitive electric eye sensing system , the operation safety has been
                                    improved greatly
                                </li>


                                <li>Output : Plain colored pieces- about 260 pcs/hr , Check and stripes- about 160
                                    pcs/
                                </li>
                            </ol>
                    ...
                    <div class="text-center">
                        <img src="/materilaHTML/assets/images/Facility/Shirt/8.JPG" class="img-fluid w-75"> <br><br>
                    </div>

                    <div>
                        <p class="img-padding-left-right ">&nbsp;Source: (<a
                                    href="https://www.iigm.in/Industries/Apparel/MID-Process/Front-Placket-Preparation-Machines/Br/Ngaishing-HongKong/Pr">Front-Placket-Preparation-Machines:
                                IIGM</a>)</p>
                    </div>
                   </div>
            </div>
